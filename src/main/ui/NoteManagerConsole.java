...
// Console-based note manager app.
public class NoteManagerConsole {
    ...
    // EFFECTS: creates a new console based Note Manager app and runs it
    public NoteManagerConsole() {
